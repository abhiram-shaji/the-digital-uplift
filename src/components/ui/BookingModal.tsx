...
export default function BookingModal() {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-[95vw] max-h-[95vh] overflow-x-auto overflow-y-auto">
        <div className="min-w-[800px]">
          {step === "select" ? (
            ...
            <>
              ...
              <div className="bg-white dark:bg-white rounded-md p-4 shadow-md ring-1 ring-gray-300 min-w-[800px]">
                <iframe
